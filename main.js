...
function Mario(game) {
    this.animation = new Animation(ASSET_MANAGER.getAsset("./img/mario_right.png"), 0, 0, 59, 300, 0.20, 7, true, true);
    this.Leftanimation = new Animation(ASSET_MANAGER.getAsset("./img/mario_left.png"), 0, 0, 56.9999999999999999999, 300, 0.20, 7, true, true);
    this.jumpAnimation = new Animation(ASSET_MANAGER.getAsset("./img/mario_right_jump_new.png"), 0, 0, 109.88888888, 132, 0.20, 9, false, false);
    this.LeftjumpAnimation = new Animation(ASSET_MANAGER.getAsset("./img/mario_left_jump_new.png"), 0, 0, 113.88888, 132, 0.20, 9, false, true);
    this.radius = 100;
    this.ground = 220;
...
Mario.prototype.update = function () {
    if ((this.x === 300 && !this.left) || (this.x === 900 && this.left)) this.jumping = true;
...
ASSET_MANAGER.queueDownload("./img/mario_right.png");
ASSET_MANAGER.queueDownload("./img/mario_right_jump_new.png");
ASSET_MANAGER.queueDownload("./img/mario_left.png");
